# -*- coding: utf-8 -*-
#
# Juego de Pygame para practicar sintaxis para estudiantes de séptimo grado.
#
...
class SyntaxGame:
    def __init__(self):
        ...
        # Syntax data for 7th grade
        self.data_es = [
            {"topic": "Oraciones Condicionales", "question": "Completa: 'Si (estudiar), (aprobar) el examen.'", "correct": "Si estudias, aprobarás el examen."},
            {"topic": "Uso de 'qué' y 'que'", "question": "Elige la correcta: 'No sabía (qué/que) hacer.'", "correct": "No sabía qué hacer."},
            {"topic": "Voz Pasiva", "question": "Cambia a voz pasiva: 'El perro comió la comida.'", "correct": "La comida fue comida por el perro."},
            {"topic": "Preposiciones", "question": "Elige la preposición correcta: 'Caminó (a/hacia) la casa.'", "correct": "Caminó hacia la casa."},
            {"topic": "Cláusulas Relativas", "question": "Combina las oraciones: 'El libro es interesante. Lo leí ayer.'", "correct": "El libro que leí ayer es interesante."},
        ]
        self.data_en = [
            {"topic": "Conditional Sentences", "question": "Complete: 'If you (study), you (pass) the exam.'", "correct": "If you study, you will pass the exam."},
            {"topic": "Using 'Who' and 'Whom'", "question": "Choose the correct one: '(Who/Whom) did you give the book to?'", "correct": "Whom did you give the book to?"},
            {"topic": "Passive Voice", "question": "Change to passive voice: 'The dog ate the food.'", "correct": "The food was eaten by the dog."},
            {"topic": "Prepositions", "question": "Choose the correct preposition: 'He walked (to/towards) the house.'", "correct": "He walked towards the house."},
            {"topic": "Relative Clauses", "question": "Combine the sentences: 'The book is interesting. I read it yesterday.'", "correct": "The book that I read yesterday is interesting."},
        ]
