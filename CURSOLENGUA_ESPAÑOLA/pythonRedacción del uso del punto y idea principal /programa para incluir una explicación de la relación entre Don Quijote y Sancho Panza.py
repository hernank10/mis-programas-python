...
relacion = """
La relación entre Don Quijote y Sancho Panza se desarrolla de manera significativa a lo largo de la obra. Inicialmente, Sancho Panza sigue a Don Quijote con la esperanza de mejorar su condición económica, pero a medida que avanzan en sus aventuras, una profunda amistad y lealtad mutua se desarrollan entre ellos.

Sancho, aunque escéptico al principio, comienza a adoptar parte del idealismo de Don Quijote, mientras que Don Quijote aprende a valorar el pragmatismo de Sancho. Esta relación se convierte en una dinámica de aprendizaje y crecimiento mutuo, llena de momentos cómicos y tiernos. A través de sus pruebas y tribulaciones, ambos personajes enfrentan la realidad y sus creencias, culminando en una amistad genuina y profunda.
"""
...
def mostrar_relacion():
    print("\nDesarrollo de la relación entre Don Quijote y Sancho Panza:\n")
    wrapped_text = textwrap.fill(relacion, width=80)
    print(wrapped_text)
