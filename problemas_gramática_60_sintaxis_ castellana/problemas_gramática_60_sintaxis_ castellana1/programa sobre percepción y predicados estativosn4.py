    ...
    def realizar_ejercicios(self):
        ...
        for i, (pregunta, opciones, respuesta_correcta) in enumerate(self.ejercicios, 1):
            ...
            if respuesta - 1 == respuesta_correcta:
                ...
                print("Incorrecto.")
                if i == 1:
                    print("Explicación: La oración correcta es 'Juan vio que María estaba nerviosa' porque los predicados estativos no pueden usarse con verbos de percepción en infinitivo.\n")
                elif i == 2:
                    print("Explicación: 'Juan oyó cantar a Pedro' describe una percepción directa, por lo que es percepción no epistémica.\n")
                elif i == 3:
                    print("Explicación: 'Estar feliz' es un predicado estativo, ya que describe un estado en lugar de una acción.\n")
        ...
        for ejercicio in self.redaccion:
            categoria = "Percepción no epistémica" if "no epistémica" in ejercicio else ("Percepción epistémica" if "epistémica" in ejercicio else "Predicado estativo")
            print(ejercicio)
            if categoria == "Percepción no epistémica":
                print("Ejemplo: Juan vio correr a su perro en el parque.")
            elif categoria == "Percepción epistémica":
                print("Ejemplo: Juan dedujo que su amigo estaba cansado.")
            else:
                print("Ejemplo: María estaba feliz después del examen.")
