...
# adverbios conectores y pronombres relativos.
...
def main():
    ...
    Contiene el diccionario con los 100 ejercicios de conectores en inglés
    ...
    print("¡Bienvenido al reto de Conectores en Inglés!")
    print("--------------------------------------------------")
    print("Responde con la traducción correcta o escribe 'salir' para terminar.")
