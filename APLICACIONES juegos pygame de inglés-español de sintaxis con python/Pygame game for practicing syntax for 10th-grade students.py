# -*- coding: utf-8 -*-
#
# Pygame game for practicing syntax for 10th-grade students.
#
...
class SyntaxGame:
    def __init__(self):
        ...
        # Syntax data for 10th grade
        self.data_es = [
            {"topic": "Voz Pasiva Refleja", "question": "Cambia a voz pasiva refleja: 'Alquilamos un apartamento.'", "correct": "Se alquila un apartamento."},
            {"topic": "Análisis de Nexos Subordinantes", "question": "Identifica el tipo de nexo: 'Lo hice de tal modo que quedó perfecto.'", "correct": "Consecutivo"},
            {"topic": "Concordancia con Pronombres", "question": "Corrige: 'Se lo entregó a ella misma, lo cual la sorprendió.'", "correct": "Se lo entregó a ella misma, lo que la sorprendió."},
            {"topic": "Paralelismo Avanzado", "question": "Corrige la oración: 'Estudiar, practicar, y que tú aprendas.'", "correct": "Estudiar, practicar y aprender."},
            {"topic": "Subjuntivo en Cláusulas", "question": "Completa: 'No hay nadie que (saber) la verdad.'", "correct": "sepa"},
        ]
        self.data_en = [
            {"topic": "Appositive and Participial Phrases", "question": "Combine: 'Dr. Smith, a doctor, spoke.' and 'Running, he fell.'", "correct": "Dr. Smith, a doctor running, fell while speaking."},
            {"topic": "Complex Subject-Verb Agreement", "question": "Correct the sentence: 'The team, along with the coach, are celebrating.'", "correct": "The team, along with the coach, is celebrating."},
            {"topic": "Advanced Modal Verbs", "question": "Complete the sentence: 'She (should have called) me yesterday.'", "correct": "should have called"},
            {"topic": "Parallelism and Rhetorical Devices", "question": "Correct the sentence: 'He likes to run, swimming, and cycling.'", "correct": "He likes to run, swim, and cycle."},
            {"topic": "Subjunctive Mood in Complex Sentences", "question": "Complete the sentence: 'I wish that it (were) Saturday.'", "correct": "were"},
        ]
