# -*- coding: utf-8 -*-
#
# Juego de Pygame para practicar oraciones subordinadas.
#
...
class SubordinateSentencesGame:
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Juego de Subordinadas 🎮")
        ...
        self.data_en = {
            1: ("Adverbial", "I went to bed early because I was tired.", "because"),
            2: ("Noun", "I know what you did last summer.", "what"),
            3: ("Adjective", "The book that I am reading is very interesting.", "that"),
            4: ("Adverbial", "She will buy the dress even if it is expensive.", "even if"),
            5: ("Noun", "He is sad that you cannot come to the party.", "that"),
            6: ("Adjective", "The house where I grew up is very old.", "where"),
        }
        self.data_es = {
            1: ("Adverbial", "Fui a la cama temprano porque estaba cansado.", "porque"),
            2: ("Sustantiva", "Sé lo que hiciste el verano pasado.", "lo que"),
            3: ("Adjetiva", "El libro que estoy leyendo es muy interesante.", "que"),
            4: ("Adverbial", "Ella comprará el vestido aunque sea caro.", "aunque"),
            5: ("Sustantiva", "Él está triste de que no puedas venir a la fiesta.", "de que"),
            6: ("Adjetiva", "La casa donde crecí es muy vieja.", "donde"),
        }
    ...
    def next_exercise(self):
        ...
        if self.language_mode == 'es':
            sub_type, question, answer = random.choice(list(self.data_es.values()))
            self.sub_type = sub_type
            self.current_question = question
            self.correct_answer = answer
        else:
            sub_type, question, answer = random.choice(list(self.data_en.values()))
            self.sub_type = sub_type
            self.current_question = question
            self.correct_answer = answer
