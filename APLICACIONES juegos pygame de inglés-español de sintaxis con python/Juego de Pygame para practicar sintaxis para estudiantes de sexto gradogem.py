# -*- coding: utf-8 -*-
#
# Juego de Pygame para practicar sintaxis para estudiantes de sexto grado.
#
...
class SyntaxGame:
    def __init__(self):
        ...
        # Datos de las oraciones para sexto grado
        self.data_es = [
            {"topic": "Concordancia de Sujeto y Verbo", "question": "Corrige: 'Los perros ladra fuerte.'", "correct": "Los perros ladran fuerte."},
            {"topic": "Uso de Coma", "question": "Añade la coma: 'Para ir a la escuela necesito una mochila libros y cuadernos.'", "correct": "Para ir a la escuela necesito una mochila, libros y cuadernos."},
            {"topic": "Formación de Oraciones", "question": "Ordena la siguiente frase: 'el jardín flores hay en.'", "correct": "Hay flores en el jardín."},
            {"topic": "Adjetivos y Pronombres", "question": "Sustituye 'el libro' por un pronombre: 'Juan leyó el libro.'", "correct": "Juan lo leyó."},
            {"topic": "Tiempo Verbal", "question": "Cambia el verbo a pasado: 'Ellos cantan una canción.'", "correct": "Ellos cantaron una canción."},
        ]
        self.data_en = [
            {"topic": "Subject-Verb Agreement", "question": "Correct: 'The dogs barks loudly.'", "correct": "The dogs bark loudly."},
            {"topic": "Using Commas", "question": "Add the comma: 'To go to school I need a backpack books and notebooks.'", "correct": "To go to school, I need a backpack, books and notebooks."},
            {"topic": "Sentence Formation", "question": "Order the following phrase: 'the garden flowers there are in.'", "correct": "There are flowers in the garden."},
            {"topic": "Adjectives and Pronouns", "question": "Replace 'the book' with a pronoun: 'John read the book.'", "correct": "John read it."},
            {"topic": "Verb Tense", "question": "Change the verb to past tense: 'They sing a song.'", "correct": "They sang a song."},
        ]
