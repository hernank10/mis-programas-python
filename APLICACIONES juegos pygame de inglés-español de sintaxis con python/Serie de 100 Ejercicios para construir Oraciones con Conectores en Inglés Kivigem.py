...
class EnglishConnectorsApp(App):
    ...
    def build(self):
        ...
        Window.clearcolor = (0.88, 0.88, 0.88, 1)  # Gris claro
        ...
        title_label = Label(text="Reto de Conectores en Inglés",
                            font_size='24sp', bold=True, color=(0.1, 0.1, 0.1, 1),
                            size_hint_y=0.2)

        # Etiqueta para el tipo de conector
        self.type_label = Label(text="", font_size='18sp', color=(0.2, 0.2, 0.2, 1),
                                size_hint_y=0.1)

        # Etiqueta para la tarea o pregunta
        self.task_label = Label(text="", font_size='16sp', color=(0.2, 0.2, 0.2, 1),
                                size_hint_y=0.2)
        ...
        check_button = Button(text="Comprobar", background_color=(0.29, 0.69, 0.31, 1), color=(1, 1, 1, 1),
        ...
        next_button = Button(text="Siguiente Ejercicio", background_color=(0.0, 0.55, 0.73, 1), color=(1, 1, 1, 1),
                             size_hint_y=0.1, font_size='18sp')
    ...
    def check_answer(self, instance):
        ...
        if clean_user_response == clean_correct_answer or (clean_user_response + '.') == clean_correct_answer or (clean_user_response + '?') == clean_correct_answer:
            ...
            self.feedback_label.color = (0.29, 0.69, 0.31, 1) # Verde
        else:
            self.feedback_label.text = f"Incorrecto. La respuesta esperada era: '{self.correct_answer}'"
            self.feedback_label.color = (0.8, 0.0, 0.0, 1) # Rojo
