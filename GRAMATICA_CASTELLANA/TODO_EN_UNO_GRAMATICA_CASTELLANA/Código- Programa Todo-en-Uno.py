...
oraciones_espanol = {
    "sol": {"simple": "El sol brilla en el cielo.", "compuesta": "El sol brilla en el cielo, y las nubes flotan tranquilamente."},
    "niño": {"simple": "El niño juega en el parque.", "compuesta": "El niño juega en el parque mientras su madre lo observa."},
    "libro": {"simple": "El libro está sobre la mesa.", "compuesta": "El libro está sobre la mesa porque lo dejé ahí después de leer."},
}

# Base de datos de palabras y oraciones predispuestas en inglés
oraciones_ingles = {
    "sun": {"simple": "The sun shines in the sky.", "compuesta": "The sun shines in the sky, and the clouds drift peacefully."},
    "child": {"simple": "The child plays in the park.", "compuesta": "The child plays in the park while his mother watches."},
    "book": {"simple": "The book is on the table.", "compuesta": "The book is on the table because I left it there after reading."},
}
...
def guardar_progreso(palabra, tipo, correcta, usuario, idioma):
    ...
    with open("progreso_general.txt", "a") as archivo:
...
def menu_principal():
    while True:
        print("=== Menú Todo-en-Uno ===")
        leer_texto("Bienvenido al programa todo en uno. Seleccione una opción.")
        ...
        if opcion == "1":
            ...
            for palabra in palabras_seleccionadas:
                ...
                print("-" * 40)
            print("\n¡Has terminado la práctica en español! Revisa tu progreso en 'progreso_general.txt'.")
            ...
            for palabra in palabras_seleccionadas:
                ...
                print("-" * 40)
            print("\n¡Has terminado la práctica en inglés! Revisa tu progreso en 'progreso_general.txt'.")
            ...
            print("¡Gracias por usar el programa todo-en-uno! Hasta pronto.")
            leer_texto("Gracias por usar el programa todo en uno. Hasta pronto.")
            break
        else:
