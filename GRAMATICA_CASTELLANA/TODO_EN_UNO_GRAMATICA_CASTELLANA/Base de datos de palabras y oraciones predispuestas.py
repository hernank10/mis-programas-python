...
# Menú principal
def menu_principal():
    print("¡Bienvenido al programa de redacción!")
    print("Se seleccionará una palabra al azar para practicar.")
    print("Redactarás una oración simple y una compuesta con ella.")
    print("El programa verificará tu redacción con oraciones predispuestas.")
