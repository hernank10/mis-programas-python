...
tipos_oracion_compuesta = {
    "yuxtapuesta": "Son oraciones unidas sin nexos, separadas por comas, punto y coma, o dos puntos. Ejemplo: 'Llegué temprano, estaba todo cerrado.'",
    "coordinada_copulativa": "Las oraciones están unidas por nexos como 'y', 'e' o 'ni'. Ejemplo: 'Juan estudia y Pedro trabaja.'",
    "coordinada_disyuntiva": "Las oraciones están unidas por nexos como 'o' u 'o bien'. Ejemplo: 'Puedes venir o quedarte en casa.'",
    "coordinada_adversativa": "Las oraciones expresan ideas opuestas, unidas por nexos como 'pero', 'sin embargo', 'aunque'. Ejemplo: 'Estudió mucho, pero no aprobó.'",
    "coordinada_distributiva": "Las oraciones se alternan, unidas por nexos como 'ya... ya', 'bien... bien'. Ejemplo: 'Bien estudia, bien trabaja, siempre está ocupado.'",
    "subordinada_sustantiva": "La oración subordinada funciona como un sustantivo dentro de la principal. Ejemplo: 'Dijo que vendría a la fiesta.'",
    "subordinada_adjetiva": "La oración subordinada funciona como un adjetivo y complementa a un sustantivo de la oración principal. Ejemplo: 'El coche que compré es rojo.'",
    "subordinada_adverbial": "La oración subordinada funciona como un adverbio dentro de la oración principal. Ejemplo: 'Cuando llegues, avísame.'",
    "subordinada_causal": "Indica la causa o el motivo de la oración principal. Ejemplo: 'No salió porque estaba lloviendo.'",
    "subordinada_condicional": "Expresa una condición para que se realice la oración principal. Ejemplo: 'Si estudias, aprobarás el examen.'"
}
