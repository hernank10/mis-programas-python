def mostrar_reglas():
    ...
    3. Uso de dígrafos:
       - 'll': Representa un solo sonido en español. ejemplo, de "lleno" se deriva "llenar" y "relleno".
...
El dígrafo "ll" es una combinación de dos letras "l" que representan un solo sonido en el español. Aunque en algunas regiones de habla hispana ha habido una tendencia hacia la "yeísmo", donde el sonido de la "ll" se pronuncia igual que la "y", su uso ortográfico sigue siendo distintivo: 

Diferenciación de significado: El uso del dígrafo "ll" puede ayudar a diferenciar significados entre palabras que, de otro modo, sonarían igual en el habla de los "yeístas". Por ejemplo, "calló" (del verbo "callar") y "cayó" (del verbo "caer"). 

Formación de palabras: La "ll" aparece en muchos sustantivos, adjetivos y verbos, como en "llama", "lluvia" y "llenar". 

Palabras derivadas: Las palabras derivadas que contienen "ll" mantienen este dígrafo en sus for
