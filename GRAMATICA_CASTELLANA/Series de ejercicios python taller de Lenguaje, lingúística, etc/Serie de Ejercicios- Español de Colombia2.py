...
def ejercicio_11_cuervo_diferencias_sutiles():
    ejecutar_ejercicio(
        "Ejercicio 11: 'Afecto' vs. 'Efecto'",
        "Elige la palabra correcta para cada frase. 'Afecto' (sentimiento) y 'Efecto' (resultado).",
        lambda: (
            print("A) El ... del calor fue que la pintura se agrietó."),
            print("B) Le tengo mucho ... a mi familia."),
            respuestas = {"A": "efecto", "B": "afecto"},
            for frase, palabra_correcta in respuestas.items():
                respuesta = input(f"Elige la palabra para la frase {frase}: ").lower()
                print("¡Correcto!") if respuesta == palabra_correcta else print(f"¡Incorrecto! La palabra correcta es '{palabra_correcta}'.")
        )
    )
...
def ejercicio_21_ser_o_estar_basico():
    ejecutar_ejercicio(
        "Ejercicio 21: Ser o Estar, lo básico",
        "Distingue entre el uso de 'ser' (permanente) y 'estar' (temporal). Completa: 'El café ... caliente.' y 'El café ... una bebida.'",
        lambda: (
            print("1. El café ... caliente."),
            print("2. El café ... una bebida."),
            respuestas = {"1": "está", "2": "es"},
...
def ejercicio_24_ser_o_estar_con_adjetivos():
    ejecutar_ejercicio(
        "Ejercicio 24: Ser/Estar con adjetivos",
        "¿Cuándo se usa 'ser' y 'estar' con adjetivos? Completa: 'La manzana ... verde (color).' y 'La manzana ... verde (inmadura).' ",
        lambda: (
            print("1. La manzana ... verde (color)."),
            print("2. La manzana ... verde (inmadura)."),
            respuestas = {"1": "es", "2": "está"},
            for num, correcta in respuestas.items():
                respuesta = input(f"Respuesta {num}: ").lower()
                print("¡Correcto!") if respuesta == correcta else print(f"¡Incorrecto! La forma correcta es '{correcta}'.")
        )
...
def ejercicio_30_ser_o_estar_en_pasado():
    ejecutar_ejercicio(
        "Ejercicio 30: Ser/Estar en pasado",
        "Usa 'era' o 'estaba' para completar la oración:\n'Cuando era joven, yo ... muy alto.'\n'Ayer, yo ... en la biblioteca.'",
        lambda: (
            print("1. Cuando era joven, yo ... muy alto."),
            print("2. Ayer, yo ... en la biblioteca."),
            respuestas = {"1": "era", "2": "estaba"},
            for num, correcta in respuestas.items():
                respuesta = input(f"Respuesta {num}: ").lower()
                print("¡Correcto!") if respuesta == correcta else print(f"¡Incorrecto! La forma correcta es '{correcta}'.")
        )
...
def ejercicio_41_concordancia_sustantivo_adjetivo():
    ejecutar_ejercicio(
        "Ejercicio 41: Concordancia sustantivo-adjetivo",
        "Completa la frase: 'La casa ... (rojo).' y 'Los carros ... (blanco).'",
        lambda: (
            print("1. La casa ... (rojo)."),
            print("2. Los carros ... (blanco)."),
            respuestas = {"1": "roja", "2": "blancos"},
            for num, correcta in respuestas.items():
                respuesta = input(f"Respuesta {num}: ").lower()
                print("¡Correcto!") if respuesta == correcta else print(f"¡Incorrecto! La forma correcta es '{correcta}'.")
        )
