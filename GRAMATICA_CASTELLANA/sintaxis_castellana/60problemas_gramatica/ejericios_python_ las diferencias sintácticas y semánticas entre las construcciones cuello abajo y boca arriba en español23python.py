...
def mostrar_teoria():
    print("Las construcciones pueden indicar una ubicación o la manera en que ocurre una acción.")
...
def agregar_ejemplo():
    locativa = input("Ingrese un ejemplo de locativa: ")
    manera = input("Ingrese un ejemplo de manera: ")
    ejemplos = cargar_ejemplos()
...
def ejercicios_escritura():
    ejercicios = [
        ...
        "Escribe una oración con 'pecho arriba'.",
        "Convierte 'El niño corrió con energía' en una construcción de manera.",
        "Transforma 'El viento soplaba fuerte' en una construcción de manera.",
        "Corrige: 'El gato cayó suelo abajo'.",
        "Explica la diferencia entre 'boca abajo' y 'de espaldas'."
    ]
...
def juego():
    ...
    if nivel == "Básico":
        ...
        respuesta = input("Juego - Nivel Intermedio: Completa la oración: 'Las lágrimas caían ______'. ")
    else:
        respuesta = input("Juego - Nivel Avanzado: Reescribe la oración cambiando la estructura: 'Lo acostaron boca arriba'. ")
...
def menu():
    while True:
        ...
        print("2. Teoría")
        print("3. Ejemplos")
        print("4. Agregar Ejemplo")
        print("5. Ejercicios de Escritura")
