...
class AumentativosApp:
    ...
    def mostrar_siguiente_ejemplo(self):
        ...
        ttk.Label(self.frame_practica, 
                 text=f"Ejemplo {self.ejemplo_actual+1}/50", 
                 font=("Arial", 12, "bold")).pack(pady=10)
        
        ttk.Label(self.frame_practica, text=f"Palabra base: {ejemplo['base']}").pack()
        ttk.Label(self.frame_practica, 
                 text=f"Forma modificada ({ejemplo['tipo'].upper()}):", 
        ...
        ttk.Button(self.frame_practica, 
                  text="Verificar Oración", 
    ...
    def mostrar_conceptos(self):
        ...
        ttk.Label(frame_contenido, 
                 text="Conceptos Clave", 
                 font=("Arial", 14, "bold")).pack()
        ttk.Label(frame_contenido, 
                 text=conceptos.strip(), 
    ...
    def mostrar_siguiente_pregunta(self):
        ...
        for texto, valor in opciones:
            ttk.Radiobutton(self.frame_cuestionario, 
                           text=texto, 
                           variable=self.respuesta, 
                           value=valor).pack(anchor="w", padx=20)
        
        ttk.Button(self.frame_cuestionario, 
                  text="Continuar", 
