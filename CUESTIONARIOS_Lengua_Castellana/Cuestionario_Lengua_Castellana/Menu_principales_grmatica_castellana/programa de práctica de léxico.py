def practicar_lexico():
    ejercicios = [
        ...
        {
            "frase": "✍️ Elige la palabra que completa mejor esta frase: 'El gato ___ en el tejado.' (a) brincó, (b) escribió, (c) nadó: ",
            "respuesta": "a",
        },
        {
        ...
        {
            "frase": "🖋️ Selecciona la opción que contiene un par de palabras homónimas: (a) casa/caza, (b) vino/vino, (c) bello/vello: ",
            "respuesta": "b",
        },
        {
    ...
    print("🏛️ ¡Bienvenido al programa de práctica de léxico! 🏛️")
    print("🌟📜✏️🕵 Responde las preguntas para mejorar tu vocabulario.\n")
    ...
    if puntaje == len(ejercicios):
        print("🧞‍♂️✍¡Perfecto!✅ ¡Tienes un vocabulario amplio y preciso!✅")
