...
def mostrar_introduccion():
    """Muestra una introducción con sonido e imagen."""
    print("\nBienvenido a los Cuestionarios Interactivos de Lengua Castellana.")
    print("Cargando recursos...")
    
    # Reproducir sonido (asegúrate de tener el archivo `intro.mp3` en el mismo directorio)
    try:
        playsound("intro.mp3")
        print("Sonido reproducido con éxito.")
    except:
        print("No se pudo reproducir el sonido. Asegúrate de tener el archivo 'intro.mp3'.")
    
    # Mostrar imagen (asegúrate de tener el archivo `introduccion.png`)
    try:
        img = Image.open("introduccion.png")
        img.show()
        print("Imagen mostrada correctamente.")
    except:
        print("No se pudo mostrar la imagen. Asegúrate de tener el archivo 'introduccion.png'.")
...
# Menú principal
def menu_principal():
    mostrar_introduccion()  # Mostrar introducción al inicio
    while True:
        print("\n--- Menú Principal ---")
