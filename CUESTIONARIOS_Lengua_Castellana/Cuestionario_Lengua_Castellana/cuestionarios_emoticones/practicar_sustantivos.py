def practicar_sustantivos():
    ejercicios = [
        ...
        {"frase": "✍️ ¿Es 'amor' un sustantivo concreto o abstracto? ", "respuesta": "abstracto"},
        ...
        {"frase": "✍️ Clasifica 'idea' como concreto o abstracto: ", "respuesta": "abstracto"},
    ...
    print("🏛 ️¡Bienvenido al programa de práctica de sustantivos en español e inglés 🏛️!")
    print("🌟📜✏️🕵 Completa los ejercicios clasificando o traduciendo los sustantivos.\n")
    ...
    if puntaje == len(ejercicios):
        print("🧞‍♂️✍ ¡Perfecto!✅ ¡Eres un experto en sustantivos!")
    elif puntaje >= len(ejercicios) * 0.7:
        print("🧞‍♂️✍ ¡Buen trabajo! Sigue practicando para perfeccionarte.")
    else:
        print("🧞‍♂️✍ No te desanimes, ¡la práctica hace al maestro!")
