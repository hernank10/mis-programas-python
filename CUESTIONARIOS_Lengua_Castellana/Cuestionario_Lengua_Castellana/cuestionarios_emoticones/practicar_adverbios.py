def practicar_adverbios():
    ejercicios = [
        ...
        {
            "frase": "✍️ Traduce al inglés el adverbio 'hoy': ",
            "respuesta": "today",
        },
        {
        ...
        {
            "frase": "✍️ ¿Qué tipo de adverbio es 'demasiado'? (modo, tiempo, lugar, cantidad, afirmación, negación, duda): ",
            "respuesta": "cantidad",
        },
        {
        ...
        {
            "frase": "✍️ Traduce al español el adverbio 'quickly': ",
            "respuesta": "rápidamente",
        },
    ]

    print("🏛️ ¡Bienvenido al programa de práctica de adverbios en español e inglés 🏛️!")
    ...
    for i, ejercicio in enumerate(ejercicios):
        ...
        respuesta_usuario = input("🧞‍♂️✍ Tu respuesta: ").strip()
    ...
    if puntaje == len(ejercicios):
        print("🧞‍♂️✍¡Perfecto!✅ ¡Eres un experto en adverbios!")
