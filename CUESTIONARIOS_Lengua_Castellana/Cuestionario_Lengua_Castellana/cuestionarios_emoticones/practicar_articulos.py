def practicar_articulos():
    ejercicios = [
        ...
        {"frase": "✍️ She found ___ apple on the table. (inglés)", "respuesta": "an"},
        ...
        {"frase": "✍️ ___ niños están en la escuela. (español)", "respuesta": "Los"},
    ...
    print("🏛️ ¡Bienvenido al programa de práctica de artículos en español e inglés! 🏛️")
    print("🌟📜✏️🕵 Completa las siguientes frases con el artículo correcto.\n")

    puntaje = 0

    for i, ejercicio in enumerate(ejercicios):
        print(f"Frase {i+1}: {ejercicio['frase']}")
        respuesta_usuario = input("🧞‍♂️✍ Escribe el artículo correcto: ").strip()
    ...
    if puntaje == len(ejercicios):
        ...
        print("🧞‍♂️✍ ¡Buen trabajo! Aún puedes mejorar.")
    else:
        print("🧞‍♂️✍ Sigue practicando, ¡puedes hacerlo mejor!")
