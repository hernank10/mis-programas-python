def main():
    print("¡Bienvenido al cuestionario de gramática!")
    ...
    preguntas = [
        {
            ...
            "respuesta": "b",
            "retroalimentacion": "El sujeto es 'perro' porque es quien realiza la acción."
        },
        {
            "pregunta": "¿Qué tipo de palabra es 'rápidamente'?",
            "opciones": ["a) Adjetivo", "b) Sustantivo", "c) Adverbio", "d) Verbo"],
            "respuesta": "c",
            "retroalimentacion": "'Rápidamente' es un adverbio porque modifica a un verbo."
        },
        {
            ...
            "respuesta": "b",
            "retroalimentacion": "La coma indica un vocativo, llamando la atención de Pedro."
        },
        {
        ...
        },
        {
            ...
            "respuesta": "b",
            "retroalimentacion": "Es pretérito pluscuamperfecto porque indica una acción pasada anterior a otra acción pasada."
        },
        {
            ...
            "respuesta": "a",
            "retroalimentacion": "Las comillas se usan para indicar una cita textual o para resaltar algo."
        },
        {
            ...
            "respuesta": "b",
            "retroalimentacion": "Es subordinada concesiva porque expresa una dificultad que no impide la acción."
        },
        {
            ...
            "respuesta": "b",
            "retroalimentacion": "Un hiato ocurre cuando dos vocales se separan en sílabas distintas."
        },
        {
            ...
            "respuesta": "d",
            "retroalimentacion": "El punto y coma conecta ideas independientes relacionadas entre sí."
        },
        {
            "pregunta": "¿Cuál es la forma correcta del plural de 'crisis'?",
            "opciones": ["a) Crisises", "b) Crisis", "c) Crisisen", "d) Crises"],
            "respuesta": "b",
            "retroalimentacion": "'Crisis' no cambia en plural porque es un sustantivo invariable."
        },
    ]
