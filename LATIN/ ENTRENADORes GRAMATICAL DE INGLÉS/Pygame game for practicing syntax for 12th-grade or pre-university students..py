# -*- coding: utf-8 -*-
#
# Pygame game for practicing syntax for 12th-grade or pre-university students.
#
...
class SyntaxGame:
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Juego de Sintaxis Preuniversitario 🎓")
        ...
        # Syntax data for 12th grade / pre-university
        self.data_es = [
            {"topic": "Subordinación compleja", "question": "Identifica la función sintáctica de la oración subordinada: 'Me alegro de que hayas venido.'", "correct": "Complemento de Régimen"},
            {"topic": "Oraciones compuestas avanzadas", "question": "Corrige: 'El problema es que, aunque estudies, no entiendes el tema.'", "correct": "El problema es que aunque estudies, no entiendes el tema."},
            {"topic": "Concordancia compleja", "question": "Completa: 'La mayoría de los estudiantes (aprobar) el examen.'", "correct": "aprobaron"},
            {"topic": "Regulación de verbos", "question": "Corrige: 'El científico se abstiene de dar opiniones sobre el tema.'", "correct": "El científico se abstiene de dar opiniones sobre el tema."},
            {"topic": "Análisis de cláusulas nominales", "question": "Identifica la función sintáctica: 'Que llegues tarde es un problema.'", "correct": "Sujeto"},
        ]
        self.data_en = [
            {"topic": "Advanced Modal Verbs", "question": "Complete the sentence: 'She (must have been) tired after her long journey.'", "correct": "must have been"},
            {"topic": "Complex Punctuation", "question": "Correct the punctuation: 'He spoke for an hour, what he said was nonsense.'", "correct": "He spoke for an hour; what he said was nonsense."},
            {"topic": "Gerunds and Infinitives", "question": "Correct the sentence: 'I am looking forward to see you.'", "correct": "I am looking forward to seeing you."},
            {"topic": "Advanced Subordinating Conjunctions", "question": "Identify the type of conjunction: 'I will help you, provided that you pay me back.'", "correct": "Conditional"},
            {"topic": "Complex Noun Clauses", "question": "Identify the function of the noun clause: 'I believe what you are saying is true.'", "correct": "Direct object"},
        ]
    ...
    def draw_elements(self):
        ...
        # Title
        title_text = "Juego de Sintaxis Preuniversitario 🎓"
