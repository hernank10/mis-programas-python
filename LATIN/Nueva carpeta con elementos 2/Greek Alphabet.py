# Python script to help practice Greek and Latin alphabets, numbers, and their pronunciation
# This script uses basic command-line interaction
...
def main():
    ...
    if choice == "1":
        ...
        test_alphabet(greek_alphabet)
    elif choice == "5":
        test_alphabet(latin_alphabet)
    elif choice == "6":
