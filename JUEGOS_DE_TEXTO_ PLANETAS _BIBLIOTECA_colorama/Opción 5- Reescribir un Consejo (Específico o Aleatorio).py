...
def mostrar_menu():
    ...
    print("5. Reescribir un consejo (específico o aleatorio)")
    print("6. Salir")
...
def reescribir_consejo():
    print("\n=== Reescribir un Consejo ===\n")
    while True:
        seleccion = input("¿Deseas reescribir un consejo específico o aleatorio? (especifico/aleatorio): ").strip().lower()
        if seleccion == 'especifico':
            try:
                numero = int(input("Ingresa el número del consejo que deseas reescribir (1-100): ").strip())
                if 1 <= numero <= 100:
                    consejo = consejos[numero - 1]
                    print(f"\nConsejo #{numero} en Español:")
                    if COLOR_ENABLED:
                ...
                print("Entrada no válida. Por favor, ingresa un número entero entre 1 y 100.")
        elif seleccion == 'aleatorio':
            consejo = random.choice(consejos)
            numero = consejos.index(consejo) + 1
            print(f"\nConsejo #{numero} en Español:")
            if COLOR_ENABLED:
                print(Fore.GREEN + f"\"{consejo['español']}\"\n" + Style.RESET_ALL)
            else:
            ...
            print("Entrada no válida. Por favor, escribe 'especifico' o 'aleatorio'.")
    input("\nPresiona Enter para continuar...")
...
def main():
    while True:
        ...
        if opcion == '1':
            ...
            if COLOR_ENABLED:
                print(Fore.RED + "\nOpción no válida. Por favor, selecciona una opción del 1 al 6." + Style.RESET_ALL)
            else:
