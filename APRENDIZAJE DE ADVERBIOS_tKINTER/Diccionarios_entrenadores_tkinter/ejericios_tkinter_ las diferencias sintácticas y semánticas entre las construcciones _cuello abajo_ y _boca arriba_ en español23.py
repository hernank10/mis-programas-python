...
def juego():
    ...
    if nivel == "Básico":
        respuesta = simpledialog.askstring("Juego - Nivel Básico", "¿Es locativa o de manera? Escribe tu respuesta:")
        messagebox.showinfo("Respuesta", f"Escribiste: {respuesta}")
    elif nivel == "Intermedio":
        respuesta = simpledialog.askstring("Juego - Nivel Intermedio", "Completa la oración: 'Las lágrimas caían ______'.")
        messagebox.showinfo("Respuesta", f"Escribiste: {respuesta}")
    else:
        respuesta = simpledialog.askstring("Juego - Nivel Avanzado", "Reescribe la oración cambiando la estructura: 'Lo acostaron boca arriba'.")
        messagebox.showinfo("Respuesta", f"Escribiste: {respuesta}")
